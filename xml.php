...
while($resultado = mysql_fetch_row($query1)){
	$xml.="&lt;database schema_name='".$resultado[1]."' default_character_set_name='".$resultado[2]."' default_collation_name='".$resultado[3]."'&gt;<br>";
	while($resultado1 = mysql_fetch_row($query2)){
		$xml.="	&lt;tabla table_name='".$resultado1[2]."' engine='".$resultado1[4]."'&gt;<br>";
		...
		while($resultado2 = mysql_fetch_row($query3)){
			...
			$xml.="		&lt;colum colum_name ='".$resultado2[3]."' data_type='".$resultado2[7]."' character_maximum_lenght='".$resultado2[8]."' colum_type='".$resultado2[14]."' colum_key='".$resultado2[15]."' extra='".$resultado2[16]."'&gt;&lt;/colum&gt;<br>";
			}	
		}
		$xml.="	&lt;/tabla&gt;<br>";
	}
